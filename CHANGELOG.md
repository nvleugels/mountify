...
- Server groups/folders organization
- Advanced SSHFS options (reconnect, cache)
- Scheduled auto-mount tasks
- Quick connect from clipboard

### [2.0.0] - Future

- Additional protocols (WebDAV, S3, FTP)
